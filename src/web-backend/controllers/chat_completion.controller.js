...
class ChatCompletion {
    ...
    chat = async (req, res) => {
        ...
        try {
            ...
            let html_upload_file = upload_files[0].originalname.indexOf(".html") > 0 ? upload_files[0].path : upload_files[1].path; //html depends
            let css_upload_file = upload_files[0].originalname.indexOf(".css") > 0 ? upload_files[0].path : upload_files[1].path; //html depends
            ...
            if (html_upload_file && css_upload_file) {
                ...
                Review the code and ensure it adheres to the provided instructions. You should meticulously examine the text, checking for compliance with each instruction. Thoroughness and accuracy are crucial in this review process. Use bullet points to clearly outline the changes needed to help organize information more effectively, making it easier for the reader to understand and follow. Specify the name of the file to make the changes. Always specify the code to change. Additionally, avoid directly mentioning the instructions, but rather explain the reasons behind the suggested improvements to foster clarity and encourages comprehension. Do not include a modified code. If the code follows all the instructions, simplay say 'All good'
                `
                ...
                -Avoid text hanging. Enclose all text content within appropriate HTML tags to maintain a structured document.	
                ...
                let messages = [
                    ...
                    { role: "user", content: `Check the following HTML code for good practices:\n\n${html_file}\n\n Refer to this HTML instructions: ${html_instructions_prompt}` }, // file readfile 
                    { role: "user", content: `Check the following css code for good practices:\n\n${css_file}\n\n Refer to this HTML instructions: ${css_instructions_prompt}` }, // file readfile 
                ]
